...
public class VImpl implements V{
    ...
    @Override public long l(long defaultValue) 
        { if(v==null || v.length()==0)return defaultValue; return Long.parseLong(v); }
    ...
    public String[] sa(String[] defaultValue) {
        ...
        return v.replace("\r", "").split("\n");
    }

    @Override public boolean isNull() { return v == null; }

    @Override public Object o(DefaultValue dv,PFs r,String name,TypeHandlerProvider thp) {
